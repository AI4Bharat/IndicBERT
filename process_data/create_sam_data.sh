...
create_data(){
	python /nlsasfs/home/ai4bharat/gramesh/fine-tuning/IndicBERT/process_data/create_mlm_data.py \
		--input_file=/nlsasfs/home/ai4bharat/gramesh/fine-tuning/sam-splits/shuf-$1 \
		--input_file_type=parallel \
		--output_file=/nlsasfs/home/ai4bharat/gramesh/fine-tuning/sam-tfrecords/shuf-$1.tfrecord \
