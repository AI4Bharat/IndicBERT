...
create_tlm_data () {
   python create_mlm_data.py \
        --input_file=/nlsasfs/home/ai4bharat/gramesh/bertteam/IndicXLM/data/gcp/samanantar_paras/en-$1 \
        --output_file=/nlsasfs/home/ai4bharat/gramesh/bertteam/IndicXLM/data/gcp/samanantar_paras/en-$1.tfrecord \
